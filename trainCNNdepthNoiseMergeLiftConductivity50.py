...
for coil in [3, 5, 7]:
    ...
    for frequency in [100, 400]:
        ...
        pickle.dump(datasetTrain, open("data/" + fname + "_" + str(coil) + "_0_Train_NoiseMergeLiftConductivityAll.pickle", "wb"))
        pickle.dump(datasetTest, open("data/" + fname + "_" + str(coil) + "_0_Test_NoiseMergeLiftConductivityAll.pickle", "wb"))
        ...
        saver.save(sess, "./model2/20181202CNNmodeldepthNoiseMergeLift" + fname + "_" + str(coil) + "_byall")
        sess.close()
