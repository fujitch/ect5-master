...
for coil in [1, 3, 5, 7]:
    for frequency in [25, 100, 400]:
        ...
        pickle.dump(datasetTrain, open("data2/" + fname + "_" + str(coil) + "_0_Train_NoiseMergeLift.pickle", "wb"))
        pickle.dump(datasetTest, open("data2/" + fname + "_" + str(coil) + "_0_Test_NoiseMergeLift.pickle", "wb"))
        ...
        saver.save(sess, "./modelDNN/20190107DNNmodeldepthNoiseMergeLift" + fname + "_" + str(coil) + "_0")
        sess.close()